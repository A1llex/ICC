...
public class IUContactos {
    ...
    public void corre() {
        ...
        while(continuar) {
            imprimeMenu();
            int opcion = leeEntero("Selecciona una opcion:");
            switch(opcion) {
                case 1:
                ...
                case 2:
					...
					Registro regi = contactos.consultar(pista);
					if(regi == null) {
						System.out.println("No se encontro ningun registro con nombre " + pista);
					} else {
                ...
                case 4:
					...
					break;
                default:
                    System.out.println("Esa no es una opcion valida del menú.");
            }
        }
    }
